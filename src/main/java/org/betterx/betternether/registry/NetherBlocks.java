...
// https://github.com/quiqueck/BetterNether/blob/1.21/src/main/java/org/betterx/betternether/registry/NetherBlocks.java
...
public class NetherBlocks {
    public static final DeferredBlock<BNNetherBrick> NETHER_BRICK_TILE_LARGE = registerBlock("nether_brick_tile_large", BNNetherBrick::new);
/*
    // Reed //
...
*/    // Bricks //
    public static final DeferredBlock<BNNetherBrick> NETHER_BRICK_TILE_SMALL = registerBlock("nether_brick_tile_small", BNNetherBrick::new);
...
*/
    @SafeVarargs
    public static <B extends Block> DeferredBlock<B> registerBlock(String name, Supplier<? extends B> blockSupplier, TagKey<Block>... tags)
    {
        return registerBlockDirectly(name, blockSupplier, tags);
    }

    @SafeVarargs
    private static <B extends Block> DeferredBlock<B> registerBlockNI(String name, Supplier<? extends B> blockSupplier, TagKey<Block>... tags)
    {
        return registerBlock(name, blockSupplier, false, tags);
    }

    @SafeVarargs
    public static <B extends Block> DeferredBlock<B> registerBlockDirectly(String name, Supplier<? extends B> blockSupplier, TagKey<Block>... tags) {
        return registerBlock(name, blockSupplier, true, tags);
    }

    @SafeVarargs
    private static <B extends Block> DeferredBlock<B> registerBlock(String name, Supplier<? extends B> blockSupplier, boolean hasItem, TagKey<Block>... tags) {
        final BlockRegistry blockRegistry = getBlockRegistry();
        if (hasItem)
            return blockRegistry.register(name, blockSupplier, tags);
        return blockRegistry.registerBlockOnly(name, blockSupplier, tags);
    }
/*
