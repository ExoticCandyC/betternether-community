...
public final class ModCore /*implements Version.ModVersionProvider*/ {
    ...
    /**
     * The DeferredRegister instance to register blocks.
     */
    public final DeferredRegister.Blocks BlocksRegistry; // PORTED

    /**
     * The DeferredRegister instance to register items.
     */
    public final DeferredRegister.Items ItemsRegistry; // PORTED

    private ModCore(String modID, String namespace) {
        LOG = LogUtils.getLogger(); //Logger.create(modID); PORTED
        log = LOG;
        modId = modID;
        this.namespace = namespace;

        BlocksRegistry = DeferredRegister.createBlocks(modId); // PORTED
        ItemsRegistry = DeferredRegister.createItems(modId);   // PORTED
